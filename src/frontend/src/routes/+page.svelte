...
<div class="row">
    <div class="col-sm-6 col-lg-3">
        ...
        <!-- Simple card -->
        <div class="card d-block">
            <img class="card-img-top" src="assets/images/tools/precipitation.png" alt="Precipitation Tool">
            <div class="card-body">
    ...
    <div class="col-sm-6 col-lg-3">
        ...
        <!-- Simple card -->
        <div class="card d-block">
            <img class="card-img-top" src="assets/images/tools/precipitation.png" alt="Card fsdaf cap">
            <div class="card-body">
